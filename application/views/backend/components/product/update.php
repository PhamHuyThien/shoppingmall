						...
						<div class="row">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="mb-4">
											...
											<textarea name="sortDesc" class="form-control" style="height: 124px;"><?php echo $row['sortDesc'] ?></textarea>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="row">
											<div class="col-lg-6">
												<div class="mb-4">
													...
													<input name="price_root" id="oldprice" class="form-control numberformat" data-type="currency" type="number" value="<?php echo $row['price'] ?>" min="0" step="1" max="1000000000">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="mb-4">
													<label for="validationCustom01" class="form-label"><span class="maudo">%</span> Khuyến mãi </label>
													<input name="sale_of" id="discount" class="form-control" type="number" value="<?php echo $row['sale'] ?>">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="mb-4">
													<label for="validationCustom01" class="form-label">Giá bán sản phẩm <span class="maudo">(*)</span></label>
													<input name="price_buy" id="newprice" class="form-control numberformat" data-type="currency" type="number" min="0" step="1" max="1000000000" value="<?php echo $row['price_sale'] ?>">
							...
							<div class="col-lg-3">
								<div class="mb-4">
									...
									<input type="text" class="form-control" name="sku" style="width:100%" placeholder="Mã sản phẩm" value="<?php echo $row['sku'] ?>">
								</div>
								<div class="mb-4">
								...
								<div class="mb-4">
									...
									<input class="form-control" type="file" id="image_list" name="img" style="width: 100%">
									<img class="uploadimgproduct" id="uploadedImage" src="public/images/products/<?php echo $row['avatar'] ?>" alt="Uploaded Image">
								</div>
							</div>
						</div>
					</div>
